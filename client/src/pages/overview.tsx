        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden md:flex items-center space-x-6" data-testid="navigation">
              <Link to="/" className="text-foreground hover:text-primary transition-colors" data-testid="nav-overview">
                Overview
              </Link>
              <Link to="/markets" className="text-muted-foreground hover:text-foreground transition-colors" data-testid="nav-markets">
                Markets
              </Link>
            </nav>
          </div>
